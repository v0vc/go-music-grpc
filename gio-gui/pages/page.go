...
type Page interface {
	...
	Layout(gtx layout.Context, th *Theme, loadSize int, zvukQuality, youQuality string) layout.Dimensions
...
func (r *Router) Layout(gtx layout.Context, th *Theme, loadSize int, zvukQuality, youQuality string) layout.Dimensions {
	...
	content := layout.Rigid(func(gtx layout.Context) layout.Dimensions {
		...
		return layout.Flex{}.Layout(gtx,
			...
			layout.Flexed(1, func(gtx layout.Context) layout.Dimensions {
				th.Theme.Bg = origBg
				return r.pages[r.current].Layout(gtx, th, loadSize, zvukQuality, youQuality)
			}),
		)
	})

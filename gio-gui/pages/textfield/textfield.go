...
func (p *Page) Layout(gtx layout.Context, th *material.Theme) layout.Dimensions {
	...
	return material.List(th, &p.List).Layout(gtx, 1, func(gtx layout.Context, _ int) layout.Dimensions {
		return layout.Flex{
			...
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
				return layout.UniformInset(unit.Dp(8)).Layout(gtx, material.Body2(th, "Responds to hover events.").Layout)
			}),
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			...
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
				return layout.UniformInset(unit.Dp(8)).Layout(gtx, material.Body2(th, "Label animates properly when you click to select the text field.").Layout)
			}),
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			...
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
				return layout.UniformInset(unit.Dp(8)).Layout(gtx, material.Body2(th, "Can have prefix and suffix elements.").Layout)
			}),
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
				if err := func() string {
			...
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
				return layout.UniformInset(unit.Dp(8)).Layout(gtx, material.Body2(th, "Can be validated.").Layout)
			}),
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			...
			layout.Rigid(func(gtx layout.Context) layout.Dimensions {
				return layout.UniformInset(unit.Dp(8)).Layout(gtx, material.Body2(th, "This text field implementation was contributed by Jack Mordaunt. Thanks Jack!").Layout)
			}),
		)
	})
}
